...
:page-excerpt: Any fool can write code computer can understand. Question is how to build human readable code. Start with a builder pattern!
:page-disqus_url: http://www.marchwicki.pl/blog/2010/11/building-a-pojo-in-an-elegant-way/
:page-redirect_from: /blog/2010/11/building-a-pojo-in-an-elegant-way/
